...
namespace ProtocolClassic.IO
{
    ...
    public sealed partial class ClassicStream : IProtocolStream
    {
        #region Properties
        ...
        public ClassicStream(INetworkTCP tcp)
        {
            _tcp = tcp;
        }
        ...
        public void WriteString(string value, int length = 0)
        {
            ...
            Buffer.BlockCopy(Encoding.UTF8.GetBytes(value), 0, final, 0, value.Length);
        ...
        public void Purge(bool async = false)
        {
            if (async)
